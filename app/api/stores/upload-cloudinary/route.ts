// Server-side store logo upload route using Cloudinary
...
export async function POST(req: Request) {
  try {
    ...
    console.log('📤 Cloudinary store logo upload request received');
    ...
    try {
      ...
      const publicId = `store_logos/${Date.now()}_${nameWithoutExt}`;
