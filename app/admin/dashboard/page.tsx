    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-[#16a34a] to-[#15803d] rounded-lg shadow-lg p-6 mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="bg-orange-500 text-white p-3 rounded-lg group-hover:scale-110 transition">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
              </div>
              <div>
                <h3 className="font-bold text-gray-900 text-lg">📊 Click Analytics</h3>
                <p className="text-sm text-gray-600">Track coupon clicks by location</p>
              </div>
            </div>
          </Link>
        </div>
