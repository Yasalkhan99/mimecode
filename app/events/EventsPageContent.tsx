            ...
            <div className="mt-4 flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 text-center z-10">
              ...
              >
                ...
                <motion.h1
                  ...
                  className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 mb-6 leading-tight"
                >
                  {latestEvent.title}
                </motion.h1>
