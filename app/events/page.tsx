      ...
      {otherEvents.length > 0 && (
        <section className="w-full px-4 sm:px-6 md:px-8 py-20 md:py-4 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            >
              <span className="inline-block text-[#ABC443] font-bold text-sm uppercase tracking-wider mb-4 px-4 py-2 bg-[#ABC443]/10 rounded-full">
                Explore More
              </span>
                  ...
                  <div className="p-6 flex flex-col flex-grow bg-white">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                      ...
                      {/* <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="bg-gradient-to-r from-[#ABC443] to-[#9BB03A] hover:from-[#9BB03A] hover:to-[#ABC443] text-white font-bold px-6 py-3 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl"
                      >
                        View Details
                      </motion.button> */}
                    </div>
